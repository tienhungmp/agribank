...
// --- CẤU HÌNH DATABASE (MYSQL / SQLITE FALLBACK) ---
const dbDialect = (process.env.DB_DIALECT as any) || "sqlite";
...
async function initDB() {
  try {
    ...
    throw error; // Let the server fail if the database is not accessible
  }
