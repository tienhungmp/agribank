        ...
        <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 animate-in fade-in slide-in-from-bottom-4">
          ...
          <div className="grid grid-cols-2 gap-8">
            ...
            <div className="p-6 bg-gray-50/50 rounded-2xl border border-gray-100 group hover:border-red-200 transition-colors">
              ...
              <p className="text-3xl font-black text-red-500 tracking-tight">{Array.isArray(result.errorLogs) ? result.errorLogs.length : 0} <span className="text-sm font-bold text-gray-400">dòng</span></p>
            </div>
          </div>

          {Array.isArray(result.errorLogs) && result.errorLogs.length > 0 && (
